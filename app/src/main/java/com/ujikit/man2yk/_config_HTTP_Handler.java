...
/**
 * Created by ujikit on 16/02/18.
 * Keterangan : file ini digunakan untuk handling tampil data
 */

public class _config_HTTP_Handler {
    private static final String classtag = _config_HTTP_Handler.class.getSimpleName();  //return name of underlying class
